...
set(DDA_ALLTOALLV_IPC_FAT_OBJ "${DEVICE_BUILD_DIR}/dda_alltoallv_ipc.o")
...
add_custom_command(
  OUTPUT  ${DDA_ALLTOALLV_IPC_FAT_OBJ}
  COMMAND ${DL_CLANG}
    -x hip ${DL_OFFLOAD_ARCH_FLAGS}
    ${DL_HIP_COMPILER_FLAGS}
    -DRCCL_DEVICE_LINKER
    ...
    -fPIC
    -w
    -c -o ${DDA_ALLTOALLV_IPC_FAT_OBJ}
    ${HIPIFY_DIR}/src/dda_alltoallv_ipc.cu.cpp
  DEPENDS ${HIPIFY_DIR}/src/dda_alltoallv_ipc.cu.cpp
  COMMENT "DL compile: dda_alltoallv_ipc.cu.cpp (has device kernels)"
  VERBATIM
)
...
add_custom_target(device_linker_build ALL
  DEPENDS ${COMMON_FAT_OBJ} ${ONERANK_FAT_OBJ} ${COLLECTIVES_FAT_OBJ} ${DDA_ALL_REDUCE_IPC_FAT_OBJ} ${DDA_REDUCE_SCATTER_IPC_FAT_OBJ} ${DDA_ALL_GATHER_IPC_FAT_OBJ} ${DDA_ALLTOALL_IPC_FAT_OBJ} ${DDA_ALLTOALLV_IPC_FAT_OBJ} ${SYM_FAT_OBJS}
)
